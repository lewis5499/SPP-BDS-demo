function [] = neuDraw(neuPosmat,name)
...
scatter(neuPosmat(:,1),neuPosmat(:,2),8,[0.28 0.57 0.54],"filled");hold on
scatter(neuPosmat(:,1),neuPosmat(:,3),8,[0.73 0.47 0.58],"filled")
scatter(neuPosmat(:,1),neuPosmat(:,4),8,[0.26 0.45 0.77],"filled")
